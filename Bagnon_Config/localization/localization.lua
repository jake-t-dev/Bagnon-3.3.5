...
L.SortIgnoreSlots = 'Slots to ignore when sorting'
L.SortIgnoreSlotsAtBottom = 'Place locked slots at bottom'
...
L.ItemSlotColor_sortignore = 'Locked slot color'
L.ShowSlotCount = 'Show free/total slot count'
L.ShowItemLevel = 'Show item level on gear'
L.ShowNewItemGlow = 'Highlight newly looted items'
L.SortOrder = 'Sort Priority'
L.SortOrder_default = 'Type'
L.SortOrder_quality = 'Quality'
L.SortOrder_name = 'Name'
L.SortOrder_level = 'Item Level'
L.ReverseSort = 'Reverse sort order'